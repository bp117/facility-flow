...
const FacilityDocumentFlow = () => {
  ...
  const [nodes, setNodes] = useState([
    {
      ...
      style: { background: nodeTypes.input, border: "1px solid #333", width: 180, textAlign: "center" }
    },
    {
      id: "2",
      type: "default",
      ...
      style: { background: nodeTypes.processing, border: "1px solid #333", width: 180, textAlign: "center", opacity: 0.5 }
    },
    {
      id: "3",
      type: "default",
      ...
      style: { background: nodeTypes.api, border: "1px solid #333", width: 180, textAlign: "center", opacity: 0.5 }
    },
    {
      id: "4",
      type: "default",
    ...
    },
    {
      ...
      style: { background: nodeTypes.ai, border: "1px solid #333", width: 180, textAlign: "center", opacity: 0.5 }
    },
    {
      id: "8",
      type: "default",
    ...
    },
    {
      ...
      style: { background: nodeTypes.decision, border: "1px solid #333", width: 180, textAlign: "center", opacity: 0.5 }
    },
    {
      id: "12",
      type: "default",
      ...
      style: { background: nodeTypes.output, border: "1px solid #333", width: 180, textAlign: "center", opacity: 0.5 }
    }
  ]);

  // Define all edges with strong visibility
  ...
  return (
    <div style={{ width: "100%", height: "100vh", border: "1px solid #ddd" }}>
